...
public class GameBalance {
    ...
    public static final int SHIP_ARMOR = 100;
    ...
    public static final int BATTLE_SHIP_LIFE = 1000;
    public static final int BATTLE_SHIP_SHIELDS = 0;
    public static final int BATTLE_SHIP_ARMOR = 50;
    ...
    public static final int CRUISER_SHIP_LIFE = 800;
    public static final int CRUISER_SHIP_SHIELDS = 100;
    public static final int CRUISER_SHIP_ARMOR = 40;
    public static final int CRUISER_SHIP_SPEED = 500;
    public static final int CRUISER_SHIP_ENERGY = 600;
    public static final int CRUISER_SHIP_POINTS = 14;

    public static final String ADMIRAL_SHIP_NAME = "Velitelská loď";
    public static final int ADMIRAL_SHIP_LIFE = 1000;
    public static final int ADMIRAL_SHIP_SHIELDS = 100;
    public static final int ADMIRAL_SHIP_ARMOR = 20;
    public static final int ADMIRAL_SHIP_SPEED = 500;
    public static final int ADMIRAL_SHIP_ENERGY = 700;
    public static final int ADMIRAL_SHIP_POINTS = 12;
    ...
    public static final int CANNON_EQUIPMENT_MAX_STRENGTH = 100;
    ...
    public static final int DOUBLE_CANNON_EQUIPMENT_MIN_STRENGTH = 120;
    public static final int DOUBLE_CANNON_EQUIPMENT_MAX_STRENGTH = 150;
    public static final int DOUBLE_CANNON_EQUIPMENT_POINTS_COST = 3;
    ...
    public static final int SIMPLE_LASER_EQUIPMENT_MAX_STRENGTH = 100;
    public static final int SIMPLE_LASER_EQUIPMENT_POINTS_COST = 3;
    /**
     * 
     * SHIELDS
     * 
    ...
    public static final int STRONGER_SHIELD_EQUIPMENT_LIFE = 250;
    public static final int STRONGER_SHIELD_EQUIPMENT_SHIELDS = 250;
    public static final int STRONGER_SHIELD_EQUIPMENT_ENERGY_COST = 120;
    public static final int STRONGER_SHIELD_EQUIPMENT_POINTS_COST = 3;
